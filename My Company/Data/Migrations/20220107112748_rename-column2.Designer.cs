...
namespace My_Company.Data.Migrations
{
    ...
    [Migration("20220107112748_rename-column2")]
    partial class renamecolumn2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("My_Company.Models.Packing", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("My_Company.Models.Packing", b =>
                {
                    b.HasOne("My_Company.Models.Order", null)
                        .WithOne("Packing")
                        .HasForeignKey("My_Company.Models.Packing", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
